...
int64 nChainStartTime = 1462371433;
...
const string strMessageMagic = "MicaCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
	{
        nSubsidy = 248000000 * COIN; // nSubsidy = 48000000 * COIN;
	}
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MicaCoin
    bool fStrictPayToScriptHash = true; // Always active in MicaCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MicaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "istributed under the MicaCoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 49069125 : 426490;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0x8dcf9e6a69b429b65475a8618dac0ead429ba7a675ede5c10c623df60287e55a"));
